...
window.FinanceCharts = {
    ...
    dashboardFromPage() {
        startChartListeners();
        requestAnimationFrame(() => renderDashboard(readChartPayload('[data-dashboard-chart-payload]')));
    },
    flow(data) {
        startChartListeners();
    ...
    flowFromPage() {
        startChartListeners();
        requestAnimationFrame(() => renderFlow(readChartPayload('[data-flow-chart-payload]')));
    },
};