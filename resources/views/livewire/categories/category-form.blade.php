        ...
        <div>
            ...
            <div class="mt-2 grid grid-cols-2 rounded-lg border border-zinc-200 bg-zinc-50 p-1 dark:border-zinc-800 dark:bg-zinc-950">
                <button
                    ...
                    @disabled($category)
                    class="rounded-md px-4 py-2 text-sm font-semibold transition disabled:cursor-not-allowed disabled:opacity-60 {{ $type === 'expense' ? 'bg-rose-600 text-white shadow-sm' : 'text-zinc-600 hover:bg-white dark:text-zinc-300 dark:hover:bg-zinc-900' }}"
                >
                    Despesa
                </button>
                <button
                    ...
                    @disabled($category)
                    class="rounded-md px-4 py-2 text-sm font-semibold transition disabled:cursor-not-allowed disabled:opacity-60 {{ $type === 'income' ? 'bg-emerald-600 text-white shadow-sm' : 'text-zinc-600 hover:bg-white dark:text-zinc-300 dark:hover:bg-zinc-900' }}"
                >
                    Receita
                </button>
            </div>
