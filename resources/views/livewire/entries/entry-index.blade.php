                    ...
                    <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                        @forelse ($entries as $entry)
                            ...
                            <tr class="transition hover:bg-zinc-50 dark:hover:bg-zinc-950/40">
                                ...
                                <td class="px-5 py-4 text-center text-zinc-600 dark:text-zinc-300">{{ $entry->reference_date->format('d/m/Y') }}</td>
                        ...
                        @empty
                            <tr><td colspan="6" class="px-5 py-12 text-center"><div class="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-zinc-100 text-zinc-500 dark:bg-zinc-800 dark:text-zinc-300"><x-ui.icon name="calendar" class="h-6 w-6" /></div><p class="mt-3 font-semibold text-zinc-900 dark:text-white">Nenhum lançamento neste mês</p><p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Quando criar transações, os lançamentos aparecem aqui.</p></td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
