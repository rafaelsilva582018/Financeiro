<div class="space-y-6" x-data="{ modal: null }" x-on:close-resource-modal.window="modal = null">
    ...
    >
        ...
        <div
            ...
            class="relative z-10 flex max-h-[92vh] w-full max-w-4xl flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-2xl dark:border-zinc-800 dark:bg-zinc-900"
        >
            <div class="flex shrink-0 items-start justify-between gap-4 border-b border-zinc-200 px-5 py-4 dark:border-zinc-800 sm:px-6">
                <div class="flex items-start gap-3">
                    <span class="mt-0.5 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-50 text-indigo-600 dark:bg-indigo-950 dark:text-indigo-300">
                        <x-ui.icon name="receipt" class="h-5 w-5" />
                    </span>
                    <div>
                        <h2 class="text-lg font-semibold text-zinc-950 dark:text-white">Nova transação</h2>
                        <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Registre receita, despesa, cartão ou recorrência.</p>
                    </div>
                </div>
                <button type="button" x-on:click="modal = null" class="rounded-lg p-2 text-zinc-500 transition hover:bg-zinc-100 hover:text-zinc-900 dark:hover:bg-zinc-800 dark:hover:text-white" aria-label="Fechar">
