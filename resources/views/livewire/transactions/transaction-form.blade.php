            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div class="md:col-span-2">
                    ...
                    <div class="mt-2 grid grid-cols-2 rounded-lg border border-zinc-200 bg-white p-1 dark:border-zinc-800 dark:bg-zinc-900">
                        <button type="button" wire:click="selectType('expense')" class="inline-flex items-center justify-center gap-2 rounded-md px-4 py-2 text-sm font-semibold transition {{ $type === 'expense' ? 'bg-rose-600 text-white shadow-sm' : 'text-zinc-600 hover:bg-zinc-50 dark:text-zinc-300 dark:hover:bg-zinc-800' }}">
                            <x-ui.icon name="arrow-down" class="h-4 w-4" />
                            Despesa
                        </button>
                        <button type="button" wire:click="selectType('income')" class="inline-flex items-center justify-center gap-2 rounded-md px-4 py-2 text-sm font-semibold transition {{ $type === 'income' ? 'bg-emerald-600 text-white shadow-sm' : 'text-zinc-600 hover:bg-zinc-50 dark:text-zinc-300 dark:hover:bg-zinc-800' }}">
                ...
                @else
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-2 grid grid-cols-2 rounded-lg border border-zinc-200 bg-zinc-50 p-1 dark:border-zinc-800 dark:bg-zinc-950">
                            <button type="button" wire:click="selectCardValueMode('total')" class="rounded-md px-3 py-2 text-sm font-semibold transition {{ $card_value_mode === 'total' ? 'bg-white text-zinc-950 shadow-sm dark:bg-zinc-900 dark:text-white' : 'text-zinc-600 hover:bg-white/70 dark:text-zinc-300 dark:hover:bg-zinc-900/70' }}">
                                Total da compra
                            </button>
                            <button type="button" wire:click="selectCardValueMode('installment')" class="rounded-md px-3 py-2 text-sm font-semibold transition {{ $card_value_mode === 'installment' ? 'bg-white text-zinc-950 shadow-sm dark:bg-zinc-900 dark:text-white' : 'text-zinc-600 hover:bg-white/70 dark:text-zinc-300 dark:hover:bg-zinc-900/70' }}">
                                Valor da parcela
                            </button>
                        </div>
